      ...
      <div className="flex flex-col md:flex-row bg-dark-red p-3 rounded-lg shadow-md shadow-black">
        ...
        <div className="text-white text-start ml-4 flex-1">
          ...
          <NextLink
            ...
            className="text-sm font-semibold mb-2 hover:underline hover:underline-white"
          >
          ...
          <p className="flex items-center text-xs mt-2 gap-2">
            ...
            General management, General business management, General industrial
            Management
          </p>
          ...
          {/* Kategori tambahan */}
          <p className="text-xs italic mt-2">Procurement</p>
        </div>
      </div>
